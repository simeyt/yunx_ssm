...
<div class="buyPageDiv">
    <form action="forecreateOrder" method="post">
        ...
        <div class="buyFlow">
            <img class="pull-left" src="img/site/yunx_big.png">
            ...
            <table class="productListTable">
                ...
                <tr>
                    <th colspan="2" class="productListTableFirstColumn">
                        ...
                        <a class="wangwanglink" href="#nowhere"> <img src="img/site/fanchuan.png" style="width: 25px;height: 25px;"> <span class="wangwangGif"></span> </a>
                    </th>
                    <th>单价</th>
                    <th>数量</th>
                    <th>小计</th>
